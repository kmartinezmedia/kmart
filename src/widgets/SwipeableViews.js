...
export class SwipeableViews extends Component {
  // Added as an ads.
  ...
  componentWillUpdate(nextProps, nextState) {
    if (this.props.onChangeIndex && this.state.indexCurrent !== nextState.indexCurrent) {
      this.props.onChangeIndex(nextState.indexCurrent, nextState.indexLatest);
    }
  }
...
So animateHeight is most likely having no effect at all.`,
    ...
    if (animateHeight) {
      containerStyle.height = heightLatest + 10;
    }
