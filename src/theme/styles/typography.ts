 ...
 */
import css from '@kmart/css.macro';
...
export const display1 = css`
  ...
  font-family: 'Graphik', 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI',
...
export const headline = css`
  ...
  font-family: 'Inter', 'Graphik', -apple-system, BlinkMacSystemFont, 'Segoe UI',
    'Roboto', 'Helvetica', 'Arial', sans-serif, 'Apple Color Emoji',
    'Segoe UI Emoji', 'Segoe UI Symbol';
`;
